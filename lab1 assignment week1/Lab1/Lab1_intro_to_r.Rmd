...
Also according to the bar plot of both data sets i assume that the counts of present day birth records are likely to be much higher than Arbuthnot's data due to the increase in population over time.
...
The plot shows that the proportion of boys born is consistently changing around 51% while in Arbuthnot's observation The proportion of boys born over time is fluctuating over time which mean that boys are born in greater proportion than girls does not hold in the U.S.
